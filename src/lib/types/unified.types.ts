/**
 * UNIFIED API TYPES (Frontend Copy)
 *
 * This file is synchronized with the backend unified.types.ts
 * It defines canonical shapes for all API requests and responses.
 */
